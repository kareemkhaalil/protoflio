...
// // import { heroData } from '../data/heroData'; // استيراد البيانات الجديدة

// // const HeroSection = () => {
// //   const { language, isRTL } = useLanguage();
// //   const currentHeroData = heroData[language]; // اختيار البيانات حسب اللغة
...
// //             >
// //               {currentHeroData.buttons.viewWork}
...
// //               {currentHeroData.buttons.contact}
// //             </Button>
// //           </motion.div>
...
//   // Function to open CV on Google Drive
//   const openCV = () => {
//     // Replace this URL with your actual Google Drive CV link
//     const cvUrl = 'https://drive.google.com/file/d/YOUR_CV_FILE_ID/view';
...
//               variant="outline"
//               onClick={openCV}
//               className="w-full sm:w-auto text-lg px-8 py-3 border-accent text-accent hover:bg-accent hover:text-accent-foreground"
//             >
//               <FileText className={`mr-2 h-5 w-5 ${isRTL ? 'ml-2 mr-0' : ''}`} />
//               {currentHeroData.buttons.viewCV}
//             </Button>
//           </motion.div>
...
const HeroSection = () => {
  ...
  const openCV = () => {
    // Replace this URL with your actual Google Drive CV link
    const cvUrl = 'https://drive.google.com/drive/folders/15WONxYop_FlgQEU-hiXc8Aa18GcqDkwN?usp=preview';
    window.open(cvUrl, '_blank');
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            {/* CV Button - Same styling as Contact button */}
            <Button
              size="lg"
              variant="outline"
              onClick={openCV}
